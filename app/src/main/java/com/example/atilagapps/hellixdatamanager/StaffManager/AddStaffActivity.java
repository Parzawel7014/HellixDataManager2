...
public class AddStaffActivity extends AppCompatActivity {
        ...
        proImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(v.getContext(), Manifest.permission.READ_EXTERNAL_STORAGE)!= PackageManager.PERMISSION_GRANTED){
                    ...
                    ActivityCompat.requestPermissions(AddStaffActivity.this,new String[]
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!validateName() | !validatePhone() | !validateAddress() | !validateSubject() | !validateSalary()) {
                    ...
                    if (res){
                        startActivity(new Intent(AddStaffActivity.this,All_Staff.class));
                        finish();
                        Toast.makeText(AddStaffActivity.this, "Successful", Toast.LENGTH_SHORT).show();
                    }else {
                        Toast.makeText(AddStaffActivity.this, "UnSuccessful", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void getfile(Uri imageUri) {
        ...
        try{
            compressor =new Compressor(AddStaffActivity.this)
                    .setMaxWidth(100)
                    .setMaxHeight(100)
                    .setQuality(50)
